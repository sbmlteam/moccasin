function xdot = case00002(time, x_values)
% function case00002 takes
%
...
%
% case00002 can be used with MATLABs odeN functions as 
%
%	[t,x] = ode23(@case00002, [0, t_end], case00002)
%
...
if (nargin == 0)
	...
	% initial values
	xdot(1) = 0.0015/compartment;
	xdot(2) = 0/compartment;

else

	% rate equations
	xdot(1) = ( - (compartment*k1*S1) + (compartment*k2*S2))/compartment;
	xdot(2) = ( + (compartment*k1*S1) - (compartment*k2*S2))/compartment;
