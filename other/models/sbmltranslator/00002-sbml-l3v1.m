function xdot = case00002(time,x)
%  synopsis:
%     xdot = case00002 (time, x)
%     x0 = case00002
%
%  case00002 can be used with odeN functions as follows:
%
%  x0 = case00002;
%  [t,x] = ode23s(@case00002, [0 100], case00002);
%  plot (t,x);
%
%  where 100 is the end time
%
%  When case00002 is used without any arguments it returns a vector of
%  the initial concentrations of the 2 floating species.
%  Otherwise case00002 should be called with two arguments:
%  time and x.  time is the current time. x is the vector of the
%  concentrations of the 2 floating species.
%  When these parameters are supplied case00002 returns a vector of 
