...
# newline has a different function inside of []
def t_inlist_NEWLINE(t):
    r'\n'
    t.type = 'COMMA'
    t.value = 'SEMICOLON'
    return t
...
def p_expr_inlist_token(p):
    '''exprinlist : exprinlist NEWLINE
                  | exprinlist SEMICOLON
                  | exprinlist COMMA'''
    p[0] = p[1]
