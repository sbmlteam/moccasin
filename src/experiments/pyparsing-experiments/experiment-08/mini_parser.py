...
# This version of the grammar handles variables and function calls appearing
# in expressions.  It subsitutes the values of variables, but only prints a
# string when a function is called (not worth doing more for this test).
...
SUB_1            = ( PI | NUMBER | FUNCTION_CALL | IDENTIFIER ).setParseAction(pushFirst)
