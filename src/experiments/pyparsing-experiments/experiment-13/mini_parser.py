...
# New features:
# - fixed bug in parsing function definitions
# - @ function refs
...
OPERAND           = Group(FUNC_OR_MATRIX_REF | ID_REF | FUNC_HANDLE | BARE_MATRIX | NUMBER | BOOLEAN)
...
STMT              = FUNCTION_DEF_STMT | CONTROL_STMT | ASSIGNMENT | EXPR
